...
/**
 * @ngdoc directive
 * @name swissMetNetDisplayApp.directive:graphicTowzWind
 * @description
 * # graphicTowzWind
 */
angular.module('swissMetNetDisplayApp')
  .directive('graphicTowzWind', function () {
    return {
      templateUrl: 'views/graphictowzwind.html',
      replace: true,
      restrict: 'E',
      scope: {},
      ...
      controller: function ($q, $scope, $http, webService, graphicService) {
        ...
        $scope.$on('update', function (event, data) {
          ...
          // skip the update
          if (data.target.indexOf('graphicTowzWind') === -1) { return; }
          var urlWind = data.data.collections.wind_towz;
          var urlWindGusts = data.data.collections.wind_gusts_towz;
          $q.all([
            $http.get(urlWind),
            ...
            $scope.chart = Chartist.Line('.ct-towz-wind-chart', {
