...
/**
 * @ngdoc directive
 * @name swissMetNetDisplayApp.directive:singleTowzHumidity
 * @description
 * # singleTowzHumidity
 */
angular.module('swissMetNetDisplayApp')
  .directive('singleTowzHumidity', function () {
    return {
      ...
      controller: function ($scope, webService) {
        ...
        $scope.$on('update', function (event, data) {
          ...
          // skip the update
          if (data.target.indexOf('singleTowzHumidity') === -1) { return; }

          // Retrieve all needed URLs
          var url = data.data.data.humidity_towz;
